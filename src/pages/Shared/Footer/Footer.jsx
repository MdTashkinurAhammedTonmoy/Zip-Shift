...
const Footer = () => {
  return (
    <footer className="footer footer-horizontal footer-center text-secondary p-10 mt-24 mb-12 bg-[#0B0B0B] rounded-4xl">
      <aside>
        <Logo></Logo>
        ...
        <p className="text-[#DADADA]">Copyright © {new Date().getFullYear()} - All right reserved</p>
      </aside>
      <nav>
