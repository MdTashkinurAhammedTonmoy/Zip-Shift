  ...
  return (
    <div>
      <div className="text-center">
        <h3 className="text-4xl font-extrabold text-[#03373D]">
          Frequently Asked Question (FAQ)
        </h3>
        <p className="text-[16px] text-[#606060] mt-6 mb-10">
      ...
      <div className="space-y-4">
        <div className="collapse collapse-arrow bg-[#FFFFFF] border border-base-300 hover:bg-[#2B828240] hover:border-[#03373D]">
